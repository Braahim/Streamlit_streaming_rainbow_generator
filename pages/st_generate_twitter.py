...
import generate_twitter.oai as oai
import generate_twitter.tweets as twe
# Configure logger
...
def page():
        ...
        with text_spinner_placeholder:
            with st.spinner("Please wait while your Tweet is being generated..."):
                ...
                if flagged:
                    ...
                    st.session_state.n_requests += 1
                    st.session_state.tweet = (
                        str(openai.complete(prompt)).strip().replace('"', "")
                    )
                    logging.info(
    ...
    with col2:
        with open(st.session_state.path_this+"/generate_twitter/moods.txt") as f:
